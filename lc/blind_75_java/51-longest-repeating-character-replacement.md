...
Given an uppercase string and k replacements, return the greatest length of a substring that can be made from one repeated character using at most k changes.
...
copying it. The source heading for this implementation is “Longest Repeating Character Replacement”.
