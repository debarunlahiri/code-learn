...
Given a binary tree root, return the number of nodes on the longest path from the root down to a leaf.
...
copying it. The source heading for this implementation is “Maximum Depth of Binary Tree”.
