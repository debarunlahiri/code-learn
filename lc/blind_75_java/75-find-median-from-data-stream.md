...
Design a structure that accepts integers from a stream and returns the current median after every insertion.
...
copying it. The source heading for this implementation is “Find Median from Data Stream”.
