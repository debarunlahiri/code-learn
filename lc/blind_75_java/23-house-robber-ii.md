...
Given money in houses arranged in a circle, maximize the amount stolen without robbing adjacent houses; the first and last houses are also adjacent.
...
copying it. The source heading for this implementation is “House Robber II”.
