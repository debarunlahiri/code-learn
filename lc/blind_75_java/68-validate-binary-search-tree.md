...
Determine whether a binary tree satisfies the strict binary-search-tree rule at every node, not merely between a node and its immediate children.
...
copying it. The source heading for this implementation is “Validate Binary Search Tree”.
