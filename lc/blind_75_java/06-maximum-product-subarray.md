...
Given an integer array, find the non-empty contiguous subarray with the greatest product. Negative values can turn a small negative product into the next maximum.
...
copying it. The source heading for this implementation is “Maximum Product Subarray”.
