...
Return the values of a binary tree level by level from top to bottom, keeping left-to-right order within each level.
...
copying it. The source heading for this implementation is “Binary Tree Level Order Traversal”.
