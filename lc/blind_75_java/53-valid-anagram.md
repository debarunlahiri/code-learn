...
Given two lowercase strings, determine whether one is an anagram of the other, meaning their character frequencies are identical.
...
copying it. The source heading for this implementation is “Valid Anagram”.
