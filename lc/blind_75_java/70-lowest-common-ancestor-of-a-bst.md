...
Given a binary search tree and two existing nodes, return their lowest common ancestor.
...
copying it. The source heading for this implementation is “Lowest Common Ancestor of BST”.
