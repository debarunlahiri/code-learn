...
Given distinct positive numbers and a target, count the ordered sequences whose elements sum to the target.
...
copying it. The source heading for this implementation is “Combination Sum”.
