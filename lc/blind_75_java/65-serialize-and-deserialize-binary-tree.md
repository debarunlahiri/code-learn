...
Design serialization and deserialization operations that convert a binary tree to a string and reconstruct the exact same structure and values.
...
copying it. The source heading for this implementation is “Serialize and Deserialize Binary Tree”.
