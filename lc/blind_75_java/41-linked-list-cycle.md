...
Given the head of a singly linked list, determine whether repeatedly following next pointers eventually revisits a node.
...
copying it. The source heading for this implementation is “Detect Cycle in a Linked List”.
