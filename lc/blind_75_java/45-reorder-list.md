...
Rearrange a linked list from L0→L1→…→Ln into L0→Ln→L1→Ln-1→… in place without changing node values.
...
copying it. The source heading for this implementation is “Reorder List”.
