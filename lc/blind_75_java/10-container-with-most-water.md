...
Given vertical line heights, choose two lines that together with the x-axis hold the greatest amount of water.
...
copying it. The source heading for this implementation is “Container With Most Water”.
