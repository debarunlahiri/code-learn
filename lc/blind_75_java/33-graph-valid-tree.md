...
Given n labeled vertices and undirected edges, determine whether the edges form exactly one valid tree.
...
copying it. The source heading for this implementation is “Graph Valid Tree”.
