...
Given a non-empty binary tree, return the maximum sum of a path that follows parent-child edges and may start and end at any nodes.
...
copying it. The source heading for this implementation is “Binary Tree Maximum Path Sum”.
