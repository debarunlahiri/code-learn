...
Each array value is the maximum jump length from that index. Decide whether the final index is reachable from the first index.
...
copying it. The source heading for this implementation is “Jump Game”.
