...
Reverse all 32 bits of an unsigned integer and return the integer represented by the reversed bit sequence.
...
### Optimized Java (Divide & Conquer with masks) — O(1) time, O(1) space
...
copying it. The source heading for this implementation is “Reverse Bits”.
