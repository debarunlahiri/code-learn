...
Given a string containing bracket characters, determine whether every opening bracket is closed by the correct type in the correct nested order.
...
copying it. The source heading for this implementation is “Valid Parentheses”.
