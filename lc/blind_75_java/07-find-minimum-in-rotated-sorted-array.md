...
Given a strictly increasing array that may have been rotated, return its smallest value in logarithmic time.
...
copying it. The source heading for this implementation is “Find Minimum in Rotated Sorted Array”.
