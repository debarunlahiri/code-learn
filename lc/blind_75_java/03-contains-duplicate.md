...
Given an integer array, determine whether any value occurs at least twice. Return false only when every element is unique.
...
copying it. The source heading for this implementation is “Contains Duplicate”.
