...
Given meeting time intervals, return the minimum number of rooms required to host every meeting.
...
copying it. The source heading for this implementation is “Meeting Rooms II”.
