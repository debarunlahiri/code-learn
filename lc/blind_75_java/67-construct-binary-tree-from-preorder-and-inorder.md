...
Given preorder and inorder traversals of a binary tree with unique values, reconstruct and return the original tree.
...
copying it. The source heading for this implementation is “Construct Binary Tree from Preorder and Inorder”.
