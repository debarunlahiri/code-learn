...
Given a binary tree root, swap the left and right children of every node and return the root.
...
copying it. The source heading for this implementation is “Invert Binary Tree”.
