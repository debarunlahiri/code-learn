...
Rotate an n by n matrix 90 degrees clockwise in place without allocating another n by n matrix.
...
copying it. The source heading for this implementation is “Rotate Image”.
