...
If a matrix cell is zero, set its entire row and column to zero. Perform the transformation without allowing newly written zeroes to corrupt the decision process.
...
copying it. The source heading for this implementation is “Set Matrix Zeroes”.
