...
Given an integer array, find the non-empty contiguous subarray with the greatest sum and return that sum.
...
### Optimized Java (Kadane's) — O(n) time, O(1) space
...
copying it. The source heading for this implementation is “Maximum Subarray”.
