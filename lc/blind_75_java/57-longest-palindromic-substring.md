...
Return the longest contiguous substring that is a palindrome. When several answers have the same length, any one is valid.
...
copying it. The source heading for this implementation is “Longest Palindromic Substring”.
