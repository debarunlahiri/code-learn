...
Given meeting time intervals, determine whether one person can attend every meeting without a time conflict.
...
copying it. The source heading for this implementation is “Meeting Rooms”.
