...
Design encode and decode operations that losslessly convert a list of arbitrary strings into one string and back, including empty strings and delimiter characters.
...
copying it. The source heading for this implementation is “Encode and Decode Strings”.
