...
Given two sorted singly linked lists, combine their existing nodes into one sorted list and return its head.
...
copying it. The source heading for this implementation is “Merge Two Sorted Lists”.
