...
Given two signed integers, compute their sum without using the plus or minus arithmetic operators.
...
copying it. The source heading for this implementation is “Sum of Two Integers”.
