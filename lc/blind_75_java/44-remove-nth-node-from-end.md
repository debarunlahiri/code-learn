...
Given a linked list and positive n, remove the nth node counted from the end and return the possibly changed head.
...
copying it. The source heading for this implementation is “Remove Nth Node From End Of List”.
