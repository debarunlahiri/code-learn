...
Given sorted non-overlapping intervals and one new interval, insert it and merge every overlap while preserving sorted order.
...
copying it. The source heading for this implementation is “Insert Interval”.
