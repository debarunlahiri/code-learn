...
Given the head of a singly linked list, reverse every next pointer and return the new head.
...
copying it. The source heading for this implementation is “Reverse a Linked List”.
