...
Given daily stock prices, choose one day to buy and a later day to sell so that the profit is as large as possible. Return zero when no profitable transaction exists.
...
copying it. The source heading for this implementation is “Best Time to Buy and Sell Stock”.
