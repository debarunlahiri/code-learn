...
Given a reference to a node in a connected undirected graph, return a deep copy containing new nodes and the same neighbor relationships.
...
copying it. The source heading for this implementation is “Clone Graph”.
