...
Given an integer array and a target, return the indices of two distinct elements whose values add to the target. Exactly one valid pair exists, and an element cannot be reused.
...
copying it. The source heading for this implementation is “Two Sum”.
