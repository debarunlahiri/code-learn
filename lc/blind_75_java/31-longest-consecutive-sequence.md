...
Given an unsorted integer array, return the length of the longest sequence of consecutive values in expected linear time.
...
copying it. The source heading for this implementation is “Longest Consecutive Sequence”.
