...
Given a binary search tree and k, return the kth smallest node value using one-based ordering.
...
copying it. The source heading for this implementation is “Kth Smallest Element in a BST”.
